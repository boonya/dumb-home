...
const isAuthSelector = createSelector(getMe, (me) => isReady(me) && me && me.isLoggedIn());

const isNotAuthSelector = createSelector(getMe, (me) => !isReady(me) || !me || !me.isLoggedIn());

const isLoadingSelector = createSelector(getMe, (me) => isLoading(me));

const getBackRedirectPath = (_, ownProps) => locationHelperBuilder({})
  .getRedirectQueryParam(ownProps) || ROUTES.Landing;
